      ...
      <div className="flex justify-center mb-12">
        <div className="stats shadow ">
          <div className="stat">
            ...
            <div className="stat-title">Service Offered</div>
          ...
          <div className="stat">
            ...
            <div className="stat-title">Attendees</div>
          ...
          <div className="stat">
            ...
            <div className="stat-title">Expert Speakers</div>
          ...
          <div className="stat">
            ...
            <div className="stat-title">Countries Hosted</div>
